...
func (ur *userRepository) FindUserByEmail(
	...
	logger.Info("Iniciando findUserByEmail repository",
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			errorMessage := fmt.Sprintf(
				"Usuario nao encontrado com esse: %s", email)
		...
		errorMessage := "Erro ao pesquisar usuario por email"
		logger.Error(errorMessage,
			err,
			zap.String("journey", "findUserByEmail"))
	...
	logger.Info("FindUserByEmail repository executado com successo",
		zap.String("journey", "findUserByEmail"),
...
func (ur *userRepository) FindUserByID(
	...
	logger.Info("Iniciando findUserByID repository",
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			errorMessage := fmt.Sprintf(
				"Usuario nao encontrado com esse ID: %s", id)
			logger.Error(errorMessage,
				err,
				zap.String("journey", "findUserByID"))
